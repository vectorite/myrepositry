...
/* --- Navigation --- */
.fpss-template-tt .navigation-wrapper {border-top:0px solid #505050;background:url(../images/tileredi_charcoal_background.jpg) repeat;padding:0;margin:0;}
.fpss-template-tt .navigation-background {cursor:pointer;border:1px solid #f90;position:absolute;z-index:8;margin:0 4px;}
.fpss-template-tt .navigation {list-style:none;margin:0;padding:6px 16px 8px;}
...
.fpss-template-tt .navigation li.navigation-control a {font-family:Tahoma, Arial, sans-serif;font-size:12px;border:none;text-align:center;padding:0 4px;margin:0;background:none;color:#f4ad02;text-decoration:none;}
