...
/* --- Slideshow Container --- */
#fpssContainer<?php echo $mid; ?>.fpss-template-tt {position:relative;width:<?php echo $width; ?>px;margin:0px auto;padding:0px;border-color:#ccc;border-style:solid;border-width:0px 0px 0px 0px;overflow:hidden;font-family:Verdana, Arial, sans-serif;}
...
.fpss-template-tt .fpssTimerContainer .fpssTimer {width:0;clear:both;height:6px;background-color:#f4ad02;}
<?php else: ?>
...
.fpss-template-tt .slidetext h1 a {font-family:"Trebuchet MS", Trebuchet, Arial, Verdana, sans-serif;font-size:26px;line-height:120%;margin:0;padding:0;color:#f4ad02;}
...
/* --- Navigation --- */
.fpss-template-tt .navigation-wrapper {border-top:0px solid #505050;background:url(../images/BlueBarRediBase.jpg) repeat;padding:0;margin:0;}
.fpss-template-tt .navigation-background {cursor:pointer;border:1px solid #f90;position:absolute;z-index:80;margin:100 4px;}
.fpss-template-tt .navigation {list-style:none;margin:0;padding:6px 20px 8px 410px;}
...
.fpss-template-tt .navigation li.navigation-control a {font-family:Tahoma, Arial, sans-serif;font-size:12px;border:none;text-align:left;padding:0 4px;margin:0;background:none;color:#f4ad02;text-decoration:none;}
