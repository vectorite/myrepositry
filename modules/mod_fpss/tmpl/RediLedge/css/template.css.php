...
?>
/**
 * @version		$Id: template.css.php 766 2012-01-05 12:05:29Z lefteris.kavadas $
...
/* --- Slideshow Container --- */
#fpssContainer<?php echo $mid; ?>.fpss-template-simple {position:relative;width:<?php echo $width; ?>px;margin:0px auto;border-color:#ccc;border-style:solid;border-width:0px 0px 0px 0px;padding:0px;overflow:hidden;font-family:"Trebuchet MS", Trebuchet, Arial, Verdana, sans-serif;}
...
#fpssContainer<?php echo $mid; ?>.fpss-template-simple .slides-wrapper .slides .slide .slidetext {position:absolute;bottom:0;left:0;right:0;width:auto;padding:0px 0px 0px 0px;margin:0;background:url(../images/transparent_bg.png);z-index:1;}
...
.fpss-template-simple .slidetext h1 a:hover {color:#ffffff;text-decoration:none;}
.fpss-template-simple .slidetext h2 {font-size:13px;margin:0;padding:0;color:#999;font-weight:normal;}
.fpss-template-simple .slidetext h3 {font-size:15px;margin:0;padding:0;color:#fafafa;}
.fpss-template-simple .slidetext h4 {font-size:13px;margin:0;padding:0;color:#999;font-style:italic;}
.fpss-template-simple .slidetext p {font-size:15px; margin:0px 0;padding:0;color:#fff;}
.fpss-template-simple .slidetext a.fpssReadMore {margin:0;padding:0px 0px;background:url(../images/readmore.png) repeat-x center;color:#fff;line-height:20px;border:1px solid #505050;text-decoration:none;display:inline;}
.fpss-template-simple .slidetext a.fpssReadMore:hover {margin:0;padding:0px 0px;background:url(../images/readmore-hover.png) repeat-x center;color:#222;line-height:20px;border:1px solid #505050;text-decoration:none;display:inline;}

/* --- Navigation --- */
#fpssContainer<?php echo $mid; ?>.fpss-template-simple div.navigation-wrapper {width:<?php echo $width; ?>px;border-top:2px solid #404040;margin:0;padding:0px 0;background:#222;}
...
.fpss-template-simple ul.navigation li a {display:block;padding:0px;margin:0;text-decoration:none;font-family:Tahoma, Arial, sans-serif;font-size:10px;color:#fff;overflow:hidden;position:relative;z-index:9;text-align:center;}
...
.fpss-template-simple ul.navigation li.navigation-control {border:none;padding:0px;width:auto;}
