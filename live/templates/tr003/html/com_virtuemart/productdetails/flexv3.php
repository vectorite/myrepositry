...
<!-- Flexible Web Design Zoom Effect END -->
	...
	// Product Edit Link END ?>
				...
				*/ ?>
				...
				<div></a><strong><P><p style='font-size:14px'><span style='color: #339966; '> FREE SHIPPING! (Contiguous US Ground 3-7 days). </span></P></strong></div><a class="modal" rel="{handler: 'iframe', size: {x: 700, y: 550}}" href="<?php echo $url ?>"><?php echo JText::_('COM_VIRTUEMART_PRODUCT_ENQUIRY_LBL') ?></a></div>
				<?php } ?>
