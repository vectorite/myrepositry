...
include_once dirname(__FILE__) . '/../assets/includes/flexibleMartGlobal1.php';
		...
		<div class="FWBrowseListContainerOut">
			...
			<div class="floatleft width45">
            	<div class="FlexibleListBrowseV1ProductName">
					...
					<div class="FlexibleListBrowseV1ProductDetailsButton" style="position: relative; top:80px; left:-175px;">
