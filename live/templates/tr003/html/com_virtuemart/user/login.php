...
?>
    <form action="index.php" method="post" name="com-login" >
       <div id="checkoutbar" class="active"><?php echo JText::_('COM_VIRTUEMART_ORDER_CONNECT_FORM'); ?></div>

<div class="checkout-content">
<table cellspacing="20" border="0">
  <tbody><tr>
    <td><?php echo JText::_('COM_VIRTUEMART_USERNAME'); ?> :</td>
    <td> <input type="text" name="username" size="18" alt=""  /></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td><?php echo JText::_('COM_VIRTUEMART_PASSWORD'); ?> :</td>
    <td> <?php if ( VmConfig::isJ15() ) { ?>
            <input type="password" id="passwd" name="passwd" class="inputbox" size="18" alt="password" />
            <?php } else { ?>
            <input id="modlgn-passwd" type="password" name="password" class="inputbox" size="18"  />
            <?php } ?></td>
    <td> <span style="font-size:11px;">(<a   href="<?php echo JRoute::_('index.php?option='.$comUserOption.'&view=reset'); ?>">
            <?php echo JText::_('COM_VIRTUEMART_ORDER_FORGOT_YOUR_PASSWORD'); ?></a>)</span></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><?php if (JPluginHelper::isEnabled('system', 'remember')) : ?>
  ...
  <tr>
    <td>&nbsp;</td>
    <td align="right"><button type="submit" name="Submit" class="default" value="" /><?php echo JText::_('COM_VIRTUEMART_LOGIN') ?></button>
            </td>
    <td>&nbsp;</td>
  </tr>
</tbody></table>
