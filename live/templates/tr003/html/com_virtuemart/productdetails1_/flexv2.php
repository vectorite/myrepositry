...
<?php if($field->custom_title == "helpful_installation_video_url"  && $field->display != ""){ ?> 
    <p><a title="Video" rel="sexylightbox" href="<?php echo $field->display; ?>?TB_iframe=1&amp;width=700&amp;height=525" class="sexy-link"><img width="16" height="16" border="0" align="absmiddle" alt="Video" src="/images/stories/vid-icon.gif">&nbsp; Installation Video</a></p>
    <?php } ?>
