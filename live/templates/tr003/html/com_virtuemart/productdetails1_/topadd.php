...
<!-- Flexible Web Design Zoom Effect END -->
	...
	<?php // Product Title ?>
	<div class="FlexibleProductDetailProductName"><?php echo $this->product->product_name.'<br>Model 123: ' . $this->product->product_sku .'<br><small>'.$this->product->product_s_desc ?></small></div>
	...
	// Product Edit Link END ?>
				...
				*/ ?>
				...
				<div></a><strong><P><p style='font-size:14px'><span style='color: #339966; '> FREE SHIPPING! (Continental US Ground 3-7 days). </span></strong></P></div><a class="modal" rel="{handler: 'iframe', size: {x: 700, y: 550}}" href="<?php echo $url ?>"><?php echo JText::_('COM_VIRTUEMART_PRODUCT_ENQUIRY_LBL') ?></a></div>
				<?php } ?>
				...
				<div class="FlexibleProductDetailShareWindow">
                	<div class="FlexibleProductDetailShareWindowLEFT"> 
                        ...
                        <div class="FlexibleProductDetailShareWindowLEFTb">     
                            <iframe src="//www.facebook.com/plugins/like.php?href&amp;send=false&amp;layout=standard&amp;width=40&amp;show_faces=false&amp;action=like&amp;colorscheme=light&amp;font&amp;height=35&amp;appId=224235480961582" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:55px; height:29px;" allowTransparency="true"></iframe>
...
<?php } // else echo JText::_('COM_VIRTUEMART_REVIEW_LOGIN'); // Login to write a review! ?>
    ...
    <p><a href="<?php echo $field->display; ?>"><img width="16" height="16" border="0" align="absmiddle" alt="Specifications" src="/images/stories/image002.jpg">&nbsp; Specifications</a></p>
    <?php } ?>

<?php if($field->custom_title == "helpful_installation_instructions_pdf_link"  && $field->display != ""){ ?> 
    <p><a href="<?php echo $field->display; ?>"><img width="16" height="16" border="0" align="absmiddle" alt="Adobe PDF" src="/images/stories/image002.jpg">&nbsp; Installation Instructions</a></p>
   	 <?php } ?>
