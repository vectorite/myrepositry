...
{
  $style = isset($attribs['artstyle']) ? $attribs['artstyle'] : 'nim-nostyle';
  $styles = array(
    'nim-nostyle' => 'modChrome_artnostyle',
    'nim-block' => 'modChrome_artblock',
    'nim-article' => 'modChrome_artarticle',
    'nim-vmenu' => 'modChrome_artvmenu'
  );
  ...
  //  'nim-...'        - overwrites module style.
  //  'nim-... suffix' - overwrites style and adds suffix to the module root tag and
  //                     to the module elements, does not add nim-... to the module elements.
  $classes = '';
...
<div class="nim-nostyle<?php echo $params->get('artx-module-classes'); ?>">
