...
class JElementOfflajnFont extends JOfflajnFakeElementBase
{
  var $_moduleName = '';
    ...
    $tabxml = JFactory::getXMLParser('Simple');
    ...
    $typexml = JFactory::getXMLParser('Simple');
    ...
    foreach($this->_google AS $t){
      ...
      $familyxml = JFactory::getXMLParser('Simple');
    ...
    $sizexml = JFactory::getXMLParser('Simple');
    ...
    $colorxml = JFactory::getXMLParser('Simple');
    ...
    $boldxml = JFactory::getXMLParser('Simple');
    ...
    $italicxml = JFactory::getXMLParser('Simple');
    ...
    $underlinexml = JFactory::getXMLParser('Simple');
    ...
    $alignxml = JFactory::getXMLParser('Simple');
    $tsxml = <<<EOD
...
EOD;
    ...
    $afontxml = JFactory::getXMLParser('Simple');
    ...
    $tshadowxml = JFactory::getXMLParser('Simple');
    $tsxml = <<<EOD
<param>
...
EOD;
    ...
    $lineheightxml = JFactory::getXMLParser('Simple');
