...
class JElementOfflajnDashboard extends JOfflajnFakeElementBase
{
  ...
  var $attr;
    ...
    if (!isset($hash)) {
      $this->generalInfo = '<iframe src="http://offlajn.com/index2.php?option=com_offlajn_update_info&amp;v='.$xmld->version[0]->data().'" frameborder="no" style="border: 0;" width="100%" height="200px" ></iframe>';
      ...
      $this->generalInfo = '<iframe src="http://offlajn.com/index2.php?option=com_offlajn_update_info&amp;hash='.base64_url_encode($hash).'&amp;v='.$xmld->version[0]->data().'&amp;u='.JURI::root().'" frameborder="no" style="border: 0;" width="100%" height="200px" ></iframe>';
