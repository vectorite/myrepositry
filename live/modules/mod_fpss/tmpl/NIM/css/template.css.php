...
.fpss-template-simple .slidetext h1 a {font-family:"Arial MS", Arial, Verdana, sans-serif;font-size:26px;line-height:120%;margin:0;padding:0;color:#fafafa;}
...
.fpss-template-simple .slidetext p {font-size:16px;margin:4px 0;padding:0;color:#fff;}
