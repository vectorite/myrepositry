...
$department_name = ($this->department) ? $this->department->name.' ' : '';
...
<?php
    if( $this->department ):
        $dpt_img = ($this->department->icon && $this->department->icon != 'nopic.png') ? '<img src="'.$this->department_folder.$this->department->icon.'" align="'.$this->settings->get('department_align', 'left').'" class="wf_dpt_img" alt="" />' : '';
        echo '<table class="wftable">';
        echo $dpt_img.$this->department->desc;
        echo '</table>';
    elseif( $this->settings->get('default_overview')):
        echo '<table class="wftable">';
