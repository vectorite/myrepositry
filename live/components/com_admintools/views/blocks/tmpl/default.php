...
<head>
	<title>
		<?php echo JFactory::getConfig()->get('sitename','Non-descript Site') ?> :: <?php echo JText::_(version_compare(JVERSION, '1.6.0', 'ge') ? 'JGLOBAL_AUTH_ACCESS_DENIED' : 'ACCESS DENIED' ); ?>
	</title>
	<style>
...
<body>
	<div id="blocked">
		<h1><?php echo JText::_(version_compare(JVERSION, '1.6.0', 'ge') ? 'JGLOBAL_AUTH_ACCESS_DENIED' : 'ACCESS DENIED' ); ?></h1>
