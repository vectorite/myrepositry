...
<table class="adminlist">
	<thead>
		<tr>
			...
			<th>
				<?php echo JHTML::_('grid.sort', 'ATOOLS_LBL_BADWORDS_WORD', 'word', $this->lists->order_Dir, $this->lists->order); ?>
			</th>
		</tr>
		<tr>
			<td></td>
			<td>
				...
				<button onclick="document.adminForm.word.value='';this.form.submit();">
	...
	<?php else : ?>
		<tr>
			<td colspan="2" align="center"><?php echo JText::_('ATOOLS_ERR_BADWORDS_NOITEMS') ?></td>
		</tr>
	<?php endif ?>
	</tbody>
</table>
