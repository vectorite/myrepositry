...
ENDHTML;
	...
	public function putOnline()
	{
		...
		$result = JFile::delete(JPATH_SITE.DS.'.htaccess');
		
		if(JFile::exists(JPATH_SITE.DS.'.htaccess.eom')) {
			$filedata = JFile::read(JPATH_SITE.DS.'.htaccess.eom');
			$filedata = explode("\n", $filedata);
			$newLines = array();
			...
			$filedata = implode("\n", $newLines);
			$result = JFile::write(JPATH_SITE.DS.'.htaccess', $filedata);
		}
