...
class AdmintoolsModelGeoblock extends FOFModel
{
	...
	{
		$check = JPATH_ADMINISTRATOR.DS.'components/com_admintools/assets/geoip/GeoIP.dat';
		return @file_exists($check);
	}
	
	public function downloadGeoIPDat()
	{
		$datFile = JPATH_ADMINISTRATOR.DS.'components/com_admintools/assets/geoip/GeoIP.dat';
