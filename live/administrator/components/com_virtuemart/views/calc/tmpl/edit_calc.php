...
<div class="col50">
	...
	<table class="admintable">
        ...
        <?php //echo VmHTML::row('raw','COM_VIRTUEMART_STORE_FORM_ZIPCODE', $this->zipcodeList ); ?>
        <tr>
			<td width="110" class="key">
				<label for="calc_zipcode">
					<?php echo JText::_('COM_VIRTUEMART_STORE_FORM_ZIPCODE'); ?>
				</label>
			</td>
			<td colspan="3">
					<?php echo $this->zipcodeList; ?>
			</td>
		</tr>
...
<?php //echo "-->",$this->calc->virtuemart_calc_id; ?>    
	</fieldset>
</div>
