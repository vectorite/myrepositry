	...
	public function getCalc(){
  		...
  		if (empty($this->_data)) {
   		...
   		$this->_data->load((int)$this->_id);
			...
			$xrefTable = $this->getTable('calc_zipcode');

			$this->_data->virtuemart_zipcode_ids = $xrefTable->load($this->_id);

			if ( $xrefTable->getError() ) {

				vmError(get_class( $this ).' virtuemart_zipcode_ids '.$xrefTable->getError());
