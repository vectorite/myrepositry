...
//     		JTable::addIncludePath(JPATH_VM_ADMINISTRATOR.DS.'tables');
    ...
    function getCustoms($custom_parent_id,$search = false){
    	...
    	vmdebug('for model');
		$query='* FROM `#__virtuemart_customs` WHERE field_type <> "R" AND field_type <> "Z" AND field_type <> "G"  AND field_type <> "W" AND field_type <> "O"  AND field_type <> "J"  AND field_type <> "K"';
		if($custom_parent_id){
