...
*/
		...
		$html .= '<div class="button2-left"><div class="blank"><a class="modal" title="'.JText::_('COM_CONTACTENHANCED_CHANGE_CONTACT_BUTTON').'"  href="'.$link.'" rel="{handler: \'iframe\', size: {x: 800, y: 450}}">'.JText::_('COM_CONTACTENHANCED_CHANGE_CONTACT_BUTTON').'</a></div></div>'."\n";
