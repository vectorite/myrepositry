...
if (count($this->items) < 1 AND ($this->state->get('filter.published') == 1  OR $this->state->get('filter.published') == '' )){
	echo $this->loadTemplate('instructions');
}
//echo $this->state->get('filter.published'); exit;
?>

<form action="<?php echo JRoute::_('index.php?option=com_contactenhanced'); ?>" method="post" name="adminForm" id="adminForm">
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					...
					<?php if ($canCreate || $canEdit) : ?>
						<a href="<?php echo JRoute::_('index.php?option=com_contactenhanced&task=contact.edit&id='.(int) $item->id); ?>">
