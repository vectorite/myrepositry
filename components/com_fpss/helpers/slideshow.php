<?php
/**
 * @version		$Id: slideshow.php 769 2012-01-05 17:03:14Z joomlaworks $
...
class FPSSHelperSlideshow {
	...
	function prepareSlide($slide, $params){
		...
		if($params->get('enableSenchaSrc')) {
			$slide->mainImage = 'https://src.sencha.io/'.$params->get('width').'/'.JURI::root().'media/com_fpss/cache/'.$slide->id.'_'.md5('Image'.$slide->id).'_m.jpg';
		}
