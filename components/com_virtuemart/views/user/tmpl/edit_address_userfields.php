...
foreach ($typefields as $typefield) {
	...
	if (($typefield == 'corefield' && (in_array($_field['name'], $corefields) && $_field['name'] != 'email' && $_field['name'] != 'agreed') )
		...
		if($_field['title'] == "State / Province / Region")
		{
		echo  str_replace('<select ', '<select aria-required="true" required="required" class="virtuemart_state_id required"', $_field['formcode']). "\n";
		}
		else
		{
