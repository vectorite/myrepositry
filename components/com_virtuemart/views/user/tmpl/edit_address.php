...
?>
<script src="//jquery-joshbush.googlecode.com/files/jquery.maskedinput-1.2.2.min.js" type="text/javascript"></script>
<script type="text/javascript">
jQuery(function($) {
$("#shipto_phone_1_field").mask("999-999-9999");
$("#shipto_phone_2_field").mask("999-999-9999");
$("#shipto_fax_field").mask("999-999-9999");
         });
</script>
