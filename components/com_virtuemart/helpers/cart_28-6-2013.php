...
//====== add ipad condition rca chetnath ================
	...
	if($ipad) {
		...
		$myparent_prod_id =  $db->loadObject();
		
		$myparent_prod_id = (int)$myparent_prod_id->virtuemart_product_id."::".(int)$myparent_prod_id->virtuemart_customfield_id.":".'47;';
			
		if(array_key_exists($myparent_prod_id, $this->products))
		 unset($this->products[$myparent_prod_id]);
		...
		//unset($this->products[$exp_pro_id[0]]);
