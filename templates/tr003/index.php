...
<html xmlns="https://www.w3.org/1999/xhtml" xml:lang="<?php echo $document->language; ?>" lang="<?php echo $document->language; ?>" dir="ltr">
...
<div class="nim-header"><div class="nim-header-position"><div class="nim-header-jpeg"><div id="header_right"><jdoc:include type="modules" name="position-31" style="art-block" /></div></div>
   <div class="nim-header-wrapper">
        <div class="cleared reset-box"></div>
        <div class="go-home"><a href="index.php"><img src="<?php echo $templateUrl; ?>/images/logo.jpg" width="454" height="79" border="0" Hspace="30" alt="Home" id="logo"></a></div>
...
if(@$row[0][0]!=9 && @$row[1][0]!=9 && @$row[2][0]!=9) {
    ...
    <style>
	  #dockcart{ display:none!important;}
	</style>
