...
<div class="browse-view">
	...
	<h4 class="FWCategoryTitle"><?php echo $this->category->category_name; ?></h4>
	...
	// Show Products ?>
		...
		<div class="FWBrowseListContainerOut">
	 		<div class="FlexibleListBrowseV1Picture width25 floatleft">
                 <?php echo JHTML::link($product->link, $product->images[0]->displayMediaThumb('class="browseProductImage"  border="0" title="'.$product->product_name.'" ',false,'class="modal"')); ?>

                <div class="FlexibleThumbBrowseV1QuickBuy"><a class="modal FlexibleBrowseV2QuickBuyA" rel="{handler: 'iframe', size: {x: 900, y: 550}}" href="<?php echo 'index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=' . $product->virtuemart_product_id . '&virtuemart_category_id=' . $product->virtuemart_category_id . '&tmpl=component&flexible=quickbuy'; ?>"  title="<?php echo $product->product_name ?>"></a></div>	 
			</div>
            <?php
	...
	if ($iBrowseProduct == $BrowseProducts_per_row or $iBrowseProduct % $BrowseProducts_per_row == 0) {
		...
		<div class="floatleft<?php echo $Browsecellwidth . $show_vertical_separator ?>" style="position:relative;">
			<div class="FlexibleBrowseV2Product">
				...
				<div class="FlexibleBrowseV2ProductPrice" id="productPrice<?php echo $product->virtuemart_product_id ?>"></div>
					<?php
					if ($this->show_prices == '1') {
						if( $product->product_unit && VmConfig::get('vm_price_show_packaging_pricelabel')) {
							echo "<strong>". JText::_('COM_VIRTUEMART_CART_PRICE_PER_UNIT').' ('.$product->product_unit."):</strong>";
				...
				<div class="FlexibleBrowseV2_action_hover" onclick="document.location.href = '<?php echo JRoute::_ ( 'index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=' . $product->virtuemart_product_id . '&virtuemart_category_id=' . $product->virtuemart_category_id ); ?>'">
                
                	<div class="FlexibleBrowseV2ProductName">
                	 
						<?php echo JHTML::link($product->link, $product->product_name); ?> 
					</div>
                    <div class="FlexibleBrowseV2QuickBuy"> <a class="modal FlexibleBrowseV2QuickBuyA" rel="{handler: 'iframe', size: {x: 900, y: 550}}" href="<?php echo 'index.php?option=com_virtuemart&view=productdetails&virtuemart_product_id=' . $product->virtuemart_product_id . '&virtuemart_category_id=' . $product->virtuemart_category_id . '&tmpl=component&flexible=quickbuy'; ?>"  title="<?php echo $product->product_name ?>"></a></div>	
