...
<div class="cart-view">
	...
	<div class="width50 floatleft">
		<div class="FlexibleCartTXT"><?php echo JText::_('COM_VIRTUEMART_CART_TITLE'); ?></div>
	</div>
...
?>
 <div id="checkoutbar" class="active"><?php echo JText::_('COM_VIRTUEMART_USER_FORM_BILLTO_INFORMATION'); ?> &  <?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_SHIPPING_LBL'); ?> </div>
