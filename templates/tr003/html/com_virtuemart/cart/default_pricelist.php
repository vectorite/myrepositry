...
<br/>
	...
	<div class="width50 floatleft">
		...
		<br/><a class="details" href="<?php echo JRoute::_('index.php?option=com_virtuemart&view=user&task=editaddresscart&addrtype=ST&cid[]='.$this->cart->lists['current_id'],$this->useXHTML,$this->useSSL) ?>">
...
<div class="checkout-content-cart"> 
		...
		foreach( $this->cart->products as $pkey =>$prow ) { ?>
             ...
             <table width="100%" border="0" class="newshoppingcart">
  <tr>
    <td rowspan="3" style="width:160px;" ><?php if ( $prow->virtuemart_media_id) {  ?>
    ...
    <td class="newshoppingcartPRICE" valign="top"><?php
  ...
  <tr>
    <td> </td>
    <td  valign="bottom"><form action="index.php" method="post" style="display: inline;">
    ...
    <td colspan="2"  valign="bottom" align="right"><a class="vmicon vm2-remove_from_cart" title="<?php echo JText::_('COM_VIRTUEMART_CART_DELETE') ?>" align="middle" href="<?php echo JRoute::_('index.php?option=com_virtuemart&view=cart&task=delete&cart_virtuemart_product_id='.$prow->cart_item_id  ) ?>"> </a></td>
  </tr>
</table>  
		...
		<tr>
			...
			<th
				...
				width="140px"> </th>
                                ...
                                <th align="right" width="100px"><?php  echo "<span  class='priceColor2'>".JText::_('COM_VIRTUEMART_CART_SUBTOTAL_TAX_AMOUNT') ?></th>
				<?php } ?>
                                <th align="right" width="100px"><?php echo "<span  class='priceColor2'>".JText::_('COM_VIRTUEMART_CART_SUBTOTAL_DISCOUNT_AMOUNT') ?></th>
								<th align="right" width="100px"><?php echo JText::_('COM_VIRTUEMART_CART_TOTAL') ?></th>
			</tr>
	...
	<tr class="sectiontableentry1">
		...
		<?php	/*	<td colspan="2" align="right"><?php echo JText::_('COM_VIRTUEMART_ORDER_PRINT_SHIPPING'); ?> </td> */?>
				...
				if(!empty($this->layoutName) && $this->layoutName=='default' && !$this->cart->automaticSelectedShipment  )
					echo JHTML::_('link', JRoute::_('index.php?view=cart&task=edit_shipment',$this->useXHTML,$this->useSSL), $this->select_shipment_text,'class="cart-select-shipping"');
				else {
		...
		<tr class="sectiontableentry1">
				...
				<?php if(!empty($this->layoutName) && $this->layoutName=='default') echo JHTML::_('link', JRoute::_('index.php?view=cart&task=editpayment',$this->useXHTML,$this->useSSL), $this->select_payment_text,'class="cart-select-payment"'); else JText::_('COM_VIRTUEMART_CART_PAYMENT'); ?> </td>

				</td>
                         <?php } else { ?>
                                    <td colspan="4" align="right"><?php echo $this->cart->cartData['paymentName']; ?> </td>
                                 <?php } ?>
                                     <?php if ( VmConfig::get('show_tax')) { ?>
