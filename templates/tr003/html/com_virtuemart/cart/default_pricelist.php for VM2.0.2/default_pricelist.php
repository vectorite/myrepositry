  ...
  <tr>
	...
	<table class="cart-summary" cellspacing="0" cellpadding="0" border="0" width="100%">
        ...
        <tr>
			...
			<td align="right" style=" padding-bottom:5px; "><?php echo "<span  style='color:gray'>".JText::_('COM_VIRTUEMART_CART_SUBTOTAL_TAX_AMOUNT')."</span>" ?></td>
                        <?php } ?>
			<td align="right" style=" "><?php echo "<span  style='color:gray'>".JText::_('COM_VIRTUEMART_CART_SUBTOTAL_DISCOUNT_AMOUNT')."</span>" ?></td>
			<td align="right" style=" "><?php echo JText::_('COM_VIRTUEMART_CART_TOTAL'); ?></td>
		  </tr>
		</tr>
		  <tr class="sectiontableentry1">
