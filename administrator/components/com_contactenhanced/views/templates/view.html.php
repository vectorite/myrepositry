...
* @since		1.5
 */
class ContactenhancedViewTemplates extends JView
{
	protected $items;
	...
	protected function addToolbar()
	{
		...
		if ($this->canDo->get('core.admin')) {
			/*JToolBarHelper::divider();
			JToolBarHelper::custom( 'templates.export', 'export', 'restore.png', 'Export' );
			$bar = & JToolBar::getInstance('toolbar');
			$bar->addButtonPath(JPATH_COMPONENT.DS.'buttons');
			$js	= ' onclick="document.ceImportSliderBox.toggle();document.adminForm.task.value=\'templates.import\';"';
			// Add a back button
