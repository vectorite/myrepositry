...
* @version		1.6
 */
class ContactenhancedModelTemplate extends JModelAdmin
{
	/**
	 ...
	 * @since	1.6
	 */
	public function getTable($type = 'Template', $prefix = 'ContactenhancedTable', $config = array())
	{
	...
	public function getForm($data = array(), $loadData = true)
	{
		...
		// Get the form.
		$form = $this->loadForm('com_contactenhanced.template', 'template', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) {
			return false;
		}
		return $form;
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_contactenhanced.edit.template.data', array());
