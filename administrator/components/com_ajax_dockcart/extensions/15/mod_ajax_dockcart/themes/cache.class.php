...
if(!defined('OfflajnMenuThemeCachea1')) {
  define("OfflajnMenuThemeCachea1", null);

  jimport('joomla.registry.registry');
  jimport('joomla.filesystem.path');
  jimport('joomla.filesystem.file');

  class OfflajnMenuThemeCachea1 extends JRegistry{
    ...
    function OfflajnMenuThemeCachea1($namespace, &$_module, &$_params){
      $this->cssCompress = 1;
      $this->jsCompress = 1;
      $this->js = array();
      $this->css = array();
