 ...
 * @version 	$Id: default.php 2061 2012-08-07 09:20:26Z RolandD $
 */
...
function doImport() {
	jQuery.ajax({
		...
		error:function (request, status, error) {
			jAlert(Joomla.JText._('COM_CSVI_ERROR_DURING_PROCESS')+"\n\n"+'Status error: '+request.status+"\n"+'Status message: '+request.statusText+"\n"+jQuery.trim(request.responseText).substring(0, 2500));
        }
	});
}
</script>
